...
**2. Исправленная версия ТЗ**
   ...
   3. Если при добавлении товар уже есть в корзине и он не противоречит условиям (в корзине может быть максимум 10 единиц одного товара; наличие по каталогу не должно меньше добавляемого количество единиц; не должно быть более 5 разных товаров; общее количество не должно превышать 20 единиц), то количество суммируется. 
   4. В корзине может находиться не более 5 различных товаров от разных производителей, суммарное количество всех товаров в корзине не может превышать 20 шт, пользователь может добавить в корзину от 1шт до 10шт одного товара.
   5. При попытке добавить товар, превышающий лимиты по количеству единиц, система должна предуприть об ошибке,что выбрано максимальное количсетво единиц товара.
   6. При попытке добавить товар, превышающий общее количество в 20 единиц, система должна предуприть об ошибке, что в корзине достигнуто максимальное количество единиц товара.
   7. При попытке добавить товар, превышающий общее количество разных товаров, система должна предуприть об ошибке, что в корзине достигнуто максимальное количество разных товаров.
   8. При удалении 1 товара в корзине используется 2 метода: уменьшение количества до 0 шт или нажатием на кнопку удаление рядом с товаром.
   ...
   11. Цена на товар фиксируется на момент добавления товара в корзину. Если цена изменилась в каталоге, система должна уведомить(всплывающее окно) пользователя об изменении цены и цена в корзине должна быть обновлена при следующем просмотре корзины.
